<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: AM Sportactiv.<br>
				wodanstr ** , **** Gelsen****.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">+49177 404****</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@anything.com" class="email__addr">a.daboussi92@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2021 AM Sportactiv
			</div>



			<div class="designby">
				Developped by Aymen Daboussi
			</div>
		</div>
	</div>
</footer>
